...
GUI.title("VOCAB LIFE")
GUI.iconbitmap('C:/Users/09723/Desktop/project1.1/icon1.ico')  #icon app ก็อปตำแหน่งไฟล์ตามด้วย icon1.ico
...
img1 = PhotoImage(file = f"savelife.png")
savelife = Button(f1,
    image = img1,
    borderwidth = 0,
    highlightthickness = 0,
...
img0 = PhotoImage(file = f"saveacademic.png")
saveaca = Button(f1,
    image = img0,
    borderwidth = 0,
    highlightthickness = 0,
...
imgup = PhotoImage(file = f"Updatevocab.png")
buttonup = Button(f1,
    image = imgup,
    borderwidth = 0,
    highlightthickness = 0,
...
img3 = PhotoImage(file = f"sql life.png")
b3 = Button(f1,
    image = img3,
    borderwidth = 0,
    highlightthickness = 0,
...
img4 = PhotoImage(file = f"sql academic.png")
b4 = Button(f1,
    image = img4,
    borderwidth = 0,
    highlightthickness = 0,
...
img00 = PhotoImage(file = f"Recite.png")
b00 = Button(f2,
    image = img00,
    borderwidth = 0,
    highlightthickness = 0,
...
img11 = PhotoImage(file = f"addvocab.png")
b11 = Button(f2,
    image = img11,
    borderwidth = 0,
    highlightthickness = 0,
...
img000 = PhotoImage(file = f"Recite.png")
b000 = Button(f3,
    image = img000,
    borderwidth = 0,
    highlightthickness = 0,
...
img111 = PhotoImage(file = f"addvocab.png")
b111 = Button(f3,
    image = img111,
    borderwidth = 0,
    highlightthickness = 0,
...
#########################################################################################
imgnext = PhotoImage(file = f"next.png")
...
imgshow = PhotoImage(file = f"show.png")
...
img1111 = PhotoImage(file = f"addvocab.png")
b1111 = Button(f4,
    image = img1111,
    borderwidth = 0,
    highlightthickness = 0,
...
############################################################
imgnext1 = PhotoImage(file = f"next.png")
...
imgshow1 = PhotoImage(file = f"show.png")
...
img11111 = PhotoImage(file = f"addvocab.png")
b11111 = Button(f5,
    image = img1111,
    borderwidth = 0,
    highlightthickness = 0,
